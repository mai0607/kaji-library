...
var Api = /** @class */ (function () {
    ...
    // NFCから借りた人を探す
    Api.prototype.getReturningBookById = function (id) {
    ...
    // NFCから本の情報を取得
    Api.prototype.getBookById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 貸出処理
    Api.prototype.createBorrowed = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 返却処理
    Api.prototype.updateBorrowed = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        console.log(error_5.response.data);
                        return [2 /*return*/, {}];
                    case 3: return [2 /*return*/];
                }
            });
